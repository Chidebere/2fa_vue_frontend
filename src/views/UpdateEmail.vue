                    ...
                    <div class="faq-section pt-12 pt-lg-24 pb-12 pb-lg-24 bg-default-1">
                      <div class="container">
                          <div class="form-title text-center">
                                <h4 class="title gr-text-4 mb-9">Edit Email</h4>
                            </div>
                        <div class="row">
                        ...
                        <el-form class="register-form" :model="userBio" :rules="rules" ref="form" @submit.native.prevent="updateEmail">
                            <el-form-item prop="email">
                                <el-input v-model="userBio.email" placeholder="Enter your email" type="email" prefix-icon="fa fa-envelope"></el-input>
                            </el-form-item>
                            <div class="form-group button-block mb-2 col-md-6">
                                <button :loading="loading" class="form-btn btn btn-primary gr-hover-y w-50">Update Email</button>
                            </div>
                        </el-form>
                            </div>
                          </div>
